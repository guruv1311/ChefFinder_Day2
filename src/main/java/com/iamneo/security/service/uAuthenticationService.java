...
import com.iamneo.security.dto.request.Userregister;
...
import com.iamneo.security.repository.UseraccRepository;

import lombok.RequiredArgsConstructor;

@Service
@RequiredArgsConstructor
public class uAuthenticationService {

    private final UseraccRepository u;
...
//    private final AuthenticationManager a;
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest crequest) {
        ...
        var user = u.findByEmail(crequest.getEmail()).orElseThrow();
