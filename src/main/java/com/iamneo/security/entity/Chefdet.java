...
//	}
	...
	public Chefdet(int chefdet_id, String chef_name, String chef_location, int chef_experience,
			String chef_speciality_cuisine, String chef_culinary_background, int chef_id) {
		super();
		this.chefdet_id = chefdet_id;
		this.chef_name = chef_name;
		this.chef_location = chef_location;
