...
public class Userfood {
	...
	@Column(name = "user_food_no")
	private int user_food_no;
	@Column(name = "user_food_name")
	private String user_food_name;
	public int getUser_food_id() {
		return user_food_id;
	}
	public int getUser_food_no() {
		return user_food_no;
	}
	public void setUser_food_no(int user_food_no) {
		this.user_food_no = user_food_no;
	}
	...
	public Userfood(int user_food_id, String user_food_name,int user_food_no) {
		super();
		this.user_food_id = user_food_id;
		this.user_food_no = user_food_no;
		this.user_food_name = user_food_name;
